...
// Mirrors defaultLayout.sampleZones + zones.LANDMARK_ART.
const ZONES = [
  { key: 'lighthouse_point', file: 'lighthouse',   x: 30, y: 4,  w: 4, h: 4, scale: 0.18,  ax: 0.5464, ay: 0.8789 },
  { key: 'treehouse_hideaway', file: 'treehouse',  x: 4,  y: 20, w: 5, h: 5, scale: 0.165, ax: 0.501,  ay: 0.8848 },
  { key: 'art_hut', file: 'art-hut',               x: 28, y: 20, w: 4, h: 4, scale: 0.15,  ax: 0.5181, ay: 0.7236 },
  { key: 'campfire_circle', file: 'campfire',      x: 15, y: 21, w: 4, h: 4, scale: 0.088, ax: 0.499,  ay: 0.75 },
  { key: 'arcade_cove', file: 'arcade',            x: 42, y: 24, w: 5, h: 4, scale: 0.135, ax: 0.5103, ay: 0.8457 },
  { key: 'calm_beach', file: 'calm-beach',         x: 5,  y: 31, w: 6, h: 4, scale: 0.075, ax: 0.5073, ay: 0.8037 },
  { key: 'welcome_dock', file: 'welcome-dock',     x: 43, y: 37, w: 6, h: 4, scale: 0.12,  ax: 0.5205, ay: 0.7676 },
];
